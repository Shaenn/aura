...
const en: Catalog = {
  ...
  agent: {
    ...
    relaunched: 'I restarted the session on the previous exchange.',
    relaunchedFresh: 'I restarted the session, but without its context: it had no identifier to resume yet.',
