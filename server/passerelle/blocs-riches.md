...
| ---------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `details`                                            | Bloc repliable — `summary` toujours visible, `is_open?` | **La piste la plus sérieuse.** Rien en Markdown ne le déclenche, mais il replierait un long tableau ou un bloc de code derrière son titre.       |
