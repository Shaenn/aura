  ...
  <q-page class="hp">
    ...
    <div class="hp-cols">
      ...
      <div ref="main" class="hp-main">
        ...
        <section v-for="s in results" :id="`sec-${s.id}`" :key="s.id" class="hp-sec surface-card" :aria-labelledby="`h-${s.id}`">
...
<script setup lang="ts">
  ...
  const resultsLabel = computed(() => (!query.value ? t('pages.help.count', helpSections().length) : t('pages.help.found', results.value.length)))
