<template>
  <q-page class="settings-page">
    ...
    <p v-if="!valid" class="banner banner--warn font-mono">
      <q-icon name="warning" size="16px" /> {{ t('pages.settings.invalidBanner') }}
    </p>
    ...
    <div v-else class="settings-content" :class="{ 'settings-content--disabled': !valid }">
      <!-- Général -->
      <section
        v-show="activeId === 'sec-general'"
        id="sec-general"
        class="surface-card settings-section"
        aria-labelledby="sec-general-title"
      >
        ...
        <SettingField
          :label="t('pages.settings.fields.language')"
          json-key="language"
          :hint="t('pages.settings.fields.languageHint')"
        >
          <input
            v-model="language"
            class="ctl-input"
            spellcheck="false"
            :aria-label="t('pages.settings.fields.language')"
          />
        </SettingField>

        <SettingField
          :label="t('pages.settings.fields.model')"
          json-key="model"
          :hint="t('pages.settings.fields.modelHint')"
        >
          <input
            v-model="model"
        ...
        <SettingField
          :label="t('pages.settings.fields.effort')"
          json-key="effortLevel"
          :hint="t('pages.settings.fields.effortHint')"
        >
          <SegmentedControl
            v-model="effortLevel"
            :options="effortOptions"
            :aria-label="t('pages.settings.fields.effort')"
          />
        </SettingField>

        <SettingField
          :label="t('pages.settings.fields.fastMode')"
          json-key="fastMode"
          :hint="t('pages.settings.fields.fastModeHint')"
        >
          <SegmentedControl
            v-model="fastMode"
            :options="triDefaultOff"
            :aria-label="t('pages.settings.fields.fastMode')"
          />
        </SettingField>

        <SettingField
          :label="t('pages.settings.fields.thinking')"
          json-key="alwaysThinkingEnabled"
          :hint="t('pages.settings.fields.thinkingHint')"
        >
          <SegmentedControl
            v-model="alwaysThinking"
            :options="triDefaultOff"
            :aria-label="t('pages.settings.fields.thinking')"
          />
        </SettingField>

        <SettingField
          :label="t('pages.settings.fields.editor')"
          json-key="editorMode"
          :hint="t('pages.settings.fields.editorHint')"
        >
          <SegmentedControl
            v-model="editorMode"
            :options="editorOptions"
            :aria-label="t('pages.settings.fields.editorAria')"
          />
        </SettingField>
      </section>
      ...
      <!-- Permissions -->
      <section
        v-show="activeId === 'sec-perms'"
        id="sec-perms"
        class="surface-card settings-section"
        aria-labelledby="sec-perms-title"
      >
        <header class="settings-section-head">
      ...
      <section
        v-show="activeId === 'sec-ui'"
        id="sec-ui"
        class="surface-card settings-section"
        aria-labelledby="sec-ui-title"
      >
        <header class="settings-section-head">
        ...
        <SettingField :label="t('pages.settings.fields.tui')" json-key="tui">
          <SegmentedControl
            v-model="tui"
            :options="tuiOptions"
            :aria-label="t('pages.settings.fields.tui')"
          />
        </SettingField>
        ...
        <SettingField :label="t('pages.settings.fields.channel')" json-key="autoUpdatesChannel">
          <SegmentedControl
            ...
            :aria-label="t('pages.settings.fields.channel')"
          />
        </SettingField>

        <SettingField
          :label="t('pages.settings.fields.cleanup')"
          json-key="cleanupPeriodDays"
          :hint="t('pages.settings.fields.cleanupHint')"
        >
          <input
...
const defaultModeOptions = computed(() =>
  MODES.map((value) => ({ label: t(`pages.settings.modes.${value}`), value })),
);
...
const triField = (key: string) =>
  computed<Tri>({ get: () => triFlag(key), set: (v) => setTriFlag(key, v) });
