  ...
  <q-page class="mc">
    ...
    <section class="surface-card mc-section" aria-labelledby="mc-set-title">
      ...
      <div class="mc-field">
        ...
        <SegmentedControl v-model="enableAll" :options="autoApproveOptions" :aria-label="t('pages.mcp.projectServers')" />
      </div>
    ...
    <ConfirmDiffDialog :proposal="srvProposal" :apply-fn="applyServer" @applied="onServerApplied" @close="srvProposal = null" />
      ...
      <q-card class="srv-card surface-card">
        <q-form class="srv-form" @submit.prevent="submitForm">
          ...
          <div class="srv-field">
            ...
            <SegmentedControl v-model="fTransport" :options="transportOptions" :aria-label="t('pages.mcp.transport')" />
          </div>
          ...
          <div class="srv-actions">
            ...
            <q-btn unelevated no-caps dense type="submit" color="primary" text-color="dark" :loading="proposingSrv" :label="t('pages.mcp.preview')" />
          </div>
        </q-form>
      </q-card>
    </q-dialog>
...
<script setup lang="ts">
  ...
  import { getMcp, proposeMcp, applyMcp, type McpInventory, type McpServerConfig } from '@/services/mcp'
