    ...
    <div class="hud-frame">
      ...
      <div class="hud-core">
        ...
        <div class="hud-primaries">
          <router-link v-for="p in primaries" :key="p.name" :to="{ name: p.name }" class="hud-primary surface-card--braced">
        ...
        <aside class="hud-sessions surface-card" aria-labelledby="hud-sessions-title">
          <div class="hud-sessions-head">
            <span class="status-dot" :class="hasActive ? 'status-dot--pulse status-dot--live' : ''" aria-hidden="true" />
          ...
          <ul v-if="sessions.length" class="hud-sessions-list">
            <li v-for="s in sessions.slice(0, 3)" :key="s.sessionId">
              <router-link class="hud-sess" :to="{ name: 'sessions', query: { sel: s.sessionId } }">
                <span class="status-dot" :class="isActive(s) ? 'status-dot--pulse status-dot--live' : ''" aria-hidden="true" />
