...
const context: MessageSchema['replay']['context'] = {
  ...
  empty:
    'No context data for this session. Turns without a usage record (synthetic models, interrupted sessions) produce none.',
  emptyPhase:
  ...
  captionAfterCompaction:
    'Window as the compaction left it — exact figure. No turn has been played in this phase yet.',
  captionPending:
    'The compaction has not yet said how large the new window is; it will be known at the end of the turn.',
  ...
  byTurnCaption:
    '{exact} growth of the window at each turn; the detail names, as an estimate, what we can attribute to it.',
  byTurnExact: 'Exact',
  ...
  residualNote:
    'Message formatting, injections we cannot read yet, and the estimator’s margin — four characters per token underestimates code.',
  residualCompacted:
    'This session having been compacted, the re-injected history summary adds to it.',
