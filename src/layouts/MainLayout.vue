      ...
      <div class="statusbar-inner">
        ...
        <div class="sb-left">
          ...
          <nav v-if="crumbs.length" class="sb-crumbs" :aria-label="t('layout.breadcrumb')">
            <template v-for="(c, i) in crumbs" :key="i">
              ...
              <router-link v-if="c.to" :to="c.to" class="sb-crumb sb-crumb--link">{{
                c.label
              }}</router-link>
        ...
        <div class="sb-right font-mono">
          <span
            ...
            :title="
              system.connected
                ? t('layout.connection.onlineTitle')
                : t('layout.connection.offlineTitle')
            "
          >
            ...
            <span
              class="status-dot"
              :class="system.connected ? 'status-dot--pulse status-dot--live' : ''"
              aria-hidden="true"
            />
          ...
          <router-link
            v-if="activeCount"
            :to="{ name: 'sessions' }"
            class="sb-stat sb-live"
            :aria-label="t('layout.live.open', activeCount)"
          >
          ...
          >
            <q-tooltip>{{
              settings.darkMode ? t('layout.theme.light') : t('layout.theme.dark')
            }}</q-tooltip>
          </q-btn>
          <q-btn
            flat
            ...
            icon="translate"
            class="sb-lang"
            :aria-label="t('layout.locale.switch')"
            @click="toggleLocale"
          >
