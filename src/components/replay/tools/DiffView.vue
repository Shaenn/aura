  ...
  <figure class="dv">
    <figcaption class="dv-head">
      ...
      <span class="dv-stat font-mono">
        ...
        <span v-if="!stat.added && !stat.removed" class="dv-stat-none">{{
          t('replay.tools.diff.identical')
        }}</span>
        <span v-if="replaceAll" class="dv-stat-scope">{{
          t('replay.tools.diff.perOccurrence')
        }}</span>
      </span>
      <q-space />
      <span v-if="replaceAll" class="dv-flag font-mono">{{
        t('replay.tools.diff.replaceAll')
      }}</span>
    ...
    <div class="dv-body" :style="{ maxHeight }">
      <table class="dv-table">
        <caption class="sr-only">
          ...
          supprimée(s)<template v-if="replaceAll"
            >, à chaque occurrence du motif dans le fichier — le nombre d'occurrences n'est pas
            connu</template
          >.
        </caption>
        <tbody>
