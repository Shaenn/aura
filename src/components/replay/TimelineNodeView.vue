<template>
  ...
  >
    ...
    <AssistantTurn v-else-if="node.kind === 'turn'" :turn="node" :card-context="cardContext" :live="live" />
    ...
    <template v-else>
      ...
      <CompactionMarker v-else-if="node.event.kind === 'compaction' && node.event.compaction" :compaction="node.event.compaction" />
